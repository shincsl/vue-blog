<template>
  <div id="blog-write">
    <el-row type="flex" justify="end" class="home-container">
      <el-col :span="16" class="blog-write-container">
      ...
      <el-col :span="4" class="blog-write-button">
        ...
        if (valid) {
          ...
          publishArticle(article, this.$store.state.token).then((res) => {
            if (res.data.success) {
              ...
              that.$router.push({path: `/articles/${res.data.data.id}`})
            } else {
