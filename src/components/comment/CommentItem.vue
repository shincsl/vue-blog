    ...
    <div>
      ...
      <div class="me-reply-list">
        <div class="me-reply-item" v-for="c in comment.childrens" :key="c.id">
          <el-avatar :size="30" fit="cover" :src="c.author.avatar"></el-avatar>
          <div style="font-size: 14px">
            <span class="me-reply-user">{{c.author.nickname}}:&nbsp;&nbsp;</span>
            <span style="margin-left: 2px;">{{c.content}}</span>
          </div>
          <div class="me-view-meta">
        ...
        <div class="me-view-comment-write" v-show="commentShow">
          ...
          <el-button type="primary" size="small" style="margin-left: 8px" @click="publishComment()">评论</el-button>
        </div>
